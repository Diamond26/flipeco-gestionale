            ...
            <React.Fragment key={s.id}>
              ...
              <div className="relative flex flex-col items-center z-10 w-24">
                <div
                  className={`
                    ...
                    ${isActive ? 'bg-[#7BB35F] text-white shadow-[0_0_20px_rgba(123,179,95,0.6)] ring-4 ring-[#7BB35F]/20' : ''}
                    ${isCompleted ? 'bg-[#7BB35F] text-white shadow-[0_0_15px_rgba(123,179,95,0.4)]' : ''}
                    ${!isActive && !isCompleted ? 'bg-surface/60 dark:bg-white/5 border border-surface dark:border-white/10 text-foreground/30' : ''}
                  `}
                >
              ...
              {idx < steps.length - 1 && (
                <div className="flex-1 h-[2px] mx-[-15px] z-0 -mt-7 relative">
                  {/* Base line */}
                  <div className="absolute inset-0 bg-surface/60 dark:bg-white/5" />
                  {/* Progress line */}
                  <div
